...
<body>
    ...
    <p>Welcome to our premium items webshop! We are a leading online retailer.</p>
    ...
    <table border="1" style="border-collapse: collapse; margin-top: 20px;">
        ...
        <tr>
            ...
            <td id="phone" style="padding: 10px;">+1 (555) 123-4567</td>
        </tr>
        <tr>
            <td style="padding: 10px;">Email</td>
            <td id="email" style="padding: 10px;">info@itemsshop.com</td>
        </tr>
    </table>
</body>
</html>
...
@app.get("/about", tags=["Items HTML"], summary="Serve the about page")
async def about_page():
    """
    Serve an HTML page with information about the items webshop.
    """
    rendered_template = jinja_env.from_string(about_template).render()
    return HTMLResponse(content=rendered_template)
...
async def read_protected_route(user: HTTPBasicCredentials = Depends(get_current_user)):
    """
